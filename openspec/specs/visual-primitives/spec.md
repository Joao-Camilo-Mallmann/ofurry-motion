...
## Purpose
Provides the library of composable visual primitives in Remotion: `TextReveal`, `Icon`, `AnimatedNumber`, `ConnectedNodes`, `DynamicChart`, and `ParticleField` built with monumental scaling, high-contrast solid highlights, and transparent alpha blending.
