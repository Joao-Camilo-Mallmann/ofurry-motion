...
| #   | Rule                                       | Directive                                                                                                                                                                                                                                                                                                               |
| --- | ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🎯  | **1. Strategic Punch Text (1-3 Words & Zero Faux-Web Clutter)** | **NUNCA** coloque parágrafos, legendas explicativas ou rodapés com esteiras/tickers densos com cara de web/template. Permitido no máximo 1 micro-tag de alta precisão (máximo 3 palavras) amarrada ao número hero. Foco total no essencial e na autoridade visual. |
...
| ⚡  | **6. Impact & Full-Timeline Fluidity (Anti-Freeze & Anti-Wobble)** | **Entrada (0-15 frames):** Mask Reveal da linha de base (`overflow: hidden`) ou snap seco com spring firme.<br>**Fluidez Contínua Durante Todo o Vídeo (15-final):** Proibido congelar a tela após o hold. A cena mantém movimento orgânico contínuo (pulsação harmônica suave em números/ícones, ondas de luz/gradiente e micro-flutuação visível), sem rotação senoidal amadora (`amplitudeRotate: 0`). |
